...
const headerColor = document.getElementById("main-header");
const menuMobile = document.getElementById("header-mobile");
const menuDesktop = document.getElementById("header-desktop");
const buttonSingIn = document.getElementById("account__sign-in");
